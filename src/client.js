...
var SCREEN_W = context.canvas.width;
var SCREEN_H = context.canvas.height;
...
var PALETTE = [ "", "#FFF", "#000", "#214a4a", "#de946b" ];
...
var POWERUP_SIZE = 32;
var HALF_POWERUP_SIZE = POWERUP_SIZE / 2;
...
var POWERUP_MESSAGE_TEXT = [ "", "Tranquilizer!", "Slow Grenade!", "Fast Grenade!" ];
// type, countdown
...
var preX, preY;
var TRANQUILIZER_PIXELS = new Uint8Array([
...
var GRENADE_POINTS = new Uint8Array([
  0,0,1,1,2,
  0,2,3,2,1,
  2,3,2,3,2,
  2,3,2,3,2,
